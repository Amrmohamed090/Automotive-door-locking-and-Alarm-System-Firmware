...
system/src/newlib/startup.o: ../system/src/newlib/startup.c
	@echo 'Building file: $<'
	@echo 'Invoking: GNU Arm Cross C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra  -g -DNDEBUG -DSTM32F401xE -DUSE_HAL_DRIVER -DHSE_VALUE=8000000 -DOS_INCLUDE_STARTUP_INIT_MULTIPLE_RAM_SECTIONS -I"../include" -I"D:\imt\ARM\ARM_WS\Lab4_Startup_Project_TODO\GPT" -I"D:\imt\ARM\ARM_WS\Lab4_Startup_Project_TODO\EXTI" -I"D:\imt\ARM\ARM_WS\Lab4_Startup_Project_TODO\keypad" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32f4-hal" -I"D:\imt\ARM\ARM_WS\Lab4_Startup_Project_TODO\Lib" -I"D:\imt\ARM\ARM_WS\Lab4_Startup_Project_TODO\Rcc" -I"D:\imt\ARM\ARM_WS\Lab4_Startup_Project_TODO\Gpio" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"system/src/newlib/startup.d" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
